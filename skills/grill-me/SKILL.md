...
Do not implement the subject directly from this entry-point skill. Complete the interview, obtain the user's confirmation of shared understanding, create the required `.context/plans/YYYY-MM-DD-<slug>.md`, and wait for a separate instruction to implement.
