...
For direct Cypher execution and schema introspection, prefer the Neuronet MCP tools already connected in this environment (`mcp__neo4j-neuronet__read_neo4j_cypher`, `write_neo4j_cypher`, `get_neo4j_schema`) over shelling out to this CLI — no separate credential setup needed. Fall back to this CLI for things Neuronet doesn't cover: Docker/Desktop container management, Aura instance provisioning, dataset loading.
