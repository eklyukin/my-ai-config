...
description: Serverless Aura Graph Analytics (AGA) GDS Sessions — covers GdsSessions,
  ...
  Does NOT handle Cypher authoring — use neo4j-cypher.
...
- **Writing Cypher queries** → `neo4j-cypher`
...
| AuraDB + Cypher API | **this skill** for AGA-specific projection/session notes; `neo4j-cypher` for query authoring |
